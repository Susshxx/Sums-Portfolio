...
const DETAILS = [
{ icon: MailIcon, label: 'Email', value: 'sumedhamali284@gmail.com', href: 'https://mail.google.com/mail/u/0/#inbox/FMfcgzQhVXHWwkSwsWsHqLMtDCrdTkdM?compose=GTvVlcRzCpXCPnRXHpMMFkFnGllvBTNWHFTSvFxvfgcHZfXDKMLFCvfKlCmrsVlCBnnCbRLWcBTlb', target: '_blank' },
{ icon: MapPinIcon, label: 'Location', value: 'Kathmandu, Nepal' },
{ icon: LinkedinIcon, label: 'LinkedIn', value: 'sumedhamali', href: 'https://linkedin.com/in/sumedhamali', target: '_blank' },
{ icon: PhoneIcon, label: 'Phone', value: '+977 9823170241', href: 'tel:+9779823170241' }];
