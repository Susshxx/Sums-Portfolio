...
const ENTRIES = [
{
  ...
  school: 'Herald College, Naxal, Kathmandu',
  period: 'Aug 2023 — Jul 2026',
  description:
  'Pursuing Bachelor of Computer Science with focus on software development and UI/UX design.'
},
{
  degree: '+2 (Higher Secondary Education)',
  school: 'Uniglobe College, Kamaladi, Kathmandu',
  period: 'Completed',
  description:
  'Completed higher secondary education with strong foundation in business management, marketing, and communication skills.'
}];


export function Education() {
  return (
    <section id="education" className="w-full bg-white px-6 border-b border-line">
